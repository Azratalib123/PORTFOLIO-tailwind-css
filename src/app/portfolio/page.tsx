    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[60vh] flex items-center bg-black text-white">
        <div className="absolute inset-0 z-0">
          ...
          <img
            src="https://wallpaperaccess.com/full/5651990.jpg?height=1200&width=1920"
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-gray-300 ">Welcome to My Portfolio</h2>
          
          <div className="space-y-8 text-gray-600">
            <div>
              <p className="mb-4">
                I&apos;m Azra, a passionate web developer specializing in HTML, CSS, JavaScript, TypeScript, and Next.js. This portfolio showcases the best of my work, where I combine creativity and technical skills to build modern, responsive web applications. With each project, my goal is to provide clean, efficient, and user-friendly solutions that cater to the unique needs of clients and users.
              </p>
            </div>
